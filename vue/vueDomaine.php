	     	...
	     	<div class="searchbar <?php echo $class; ?>" >
					<form class="searchbar" action="index.php" method="post">
						<div id="search_dom1" class="search_dom">
							...
							<input type="text" name="specialite" placeholder="Médecin, spécialité..." onfocus="focused(1)" onblur="unfocused(1)" >
						</div>
						...
						<div class="valid_dom">
							<input type="submit" onvalue=unfocused(this)"Rechercher">
						</div>
					</form>
	      </div>
	    </div>
