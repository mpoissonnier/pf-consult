...
// AUTOCOMPLETION
  ...
  $("#ville").autocomplete({
    source: function (request, response) {
      var objData = {};
      objData = { element : request.term, };
      $.ajax({
        url: "./modele/dao/rechercheVilleCodePostalComplete.php",
        dataType: "json",
        data: objData,
        type: 'GET'
      })
  ...
  // AutoCompletion specialiste/specialite
  $("#specialiste").autocomplete({
    source: function (request, response) {
      var objData = {};
      objData = { element : request.term, };
      $.ajax({
        url: "./modele/dao/rechercheSpecialisteSpecialiteComplete.php",
        dataType: "json",
        data: objData,
        type: 'GET'
      })
        ...
        response($.map(data, function (item) {
          if (item.Prenom == null) {
            ...
            return {
              ...
              value: function () {
                $('#specialiste').val(item.Nom + " " + item.Prenom);
